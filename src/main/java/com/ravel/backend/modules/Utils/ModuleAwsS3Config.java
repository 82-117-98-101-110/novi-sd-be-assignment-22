package com.ravel.backend.modules.Utils;
...
@Service
public class ModuleAwsS3Config {
	...
	private String url = "https://novi-ruben.s3.eu-central-1.amazonaws.com/";

	// Your bucket name.
	//    @Value("${amazon.s3.bucket-name}")
	private String bucketName = "novi-modules";
